...
<body>
<form action="signuserp.php" method="post">
...
<div class="form-group">
  ...
  <input  name="namap" placeholder="ID Kucing" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<!-- radio checks -->
 <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="jkp" value="yes" />Laki-laki
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="jkp" value="no" />Perempuan
                                </label>
                            </div>
                        </div>
                    </div>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Agama</label>
    ...
    <select name="agama" class="form-control selectpicker" >
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="telp" placeholder="No Telpon" class="form-control"  type="text">
    </div>
  </div>
</div>
